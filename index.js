...
const unfundedGamesString = unfundedGames === 0 ? "no" : unfundedGames;

// create a new DOM element containing the template string and append it to the description container
const newElement = document.createElement("p");
newElement.innerHTML = `There are ${unfundedGamesString.toLocaleString()} unfunded games on this site.`;
